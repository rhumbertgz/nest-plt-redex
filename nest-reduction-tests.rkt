...
;  (test-->> NEST-R-Local
;            (term  ((actor root () () () () (new-actor (let (prf (let (prf (pattern p1 (:msg x y))) in prf)) 
;                                                         in  (let (rrf (reaction r1 lm st #true)) 
;                                                               in  (react-to prf rrf)))))))
;            (term  ((actor root () () () () (ref id_new))  
;                    (actor id_new () ((p1 . (((:msg x y) nil) ()))) ((r1 . (lm st #true))) (((ref p1) . ((ref r1)))) ()))))
  ...
  (test-->> NEST-R-Local
            ...
            (term  ((actor root () () () () ())  
                    (actor id_new ((id_msg tstamp (:msg2 1))) ((p1 . (((:msg x y) nil) ()))) ((r1 . (lm st #true))) (((ref p1) . ((ref r1)))) ()))))

  ;; Send a message to an actor and check pattern match
  (test-->> NEST-R-Local
            (term  ((actor root () () () () (let (newActor (new-actor (let (prf (pattern p1 (:msg x y)))
                                                              in  (let (rrf (reaction r1 lm st #true)) 
                                                                    in  (react-to prf rrf)))))
...
;                                              in (send newActor (:msg2 1))))))
;            (term  ((actor root () () () () (ref id_new))  
;                    (actor id_new ((msg_id tstamp (:msg2 1))) ((p1 . (((:msg x y) nil) ()))) ((r1 . (lm st #true))) (((ref p1) . ((ref r1)))) ()))))
